...
function remainingBakeTime(minIntheOven){
    console.log(minIntheOven)
  return  bakingTime() - minIntheOven
}
...
function calculatePreparationTime (numOfLayers){
     console.log("This is number of layers", numOfLayers)
...
function totalTimeSpent(numOfLayers, minIntheOven){
   let total = calculatePreparationTime(numOfLayers) + minIntheOven
   return total
}
